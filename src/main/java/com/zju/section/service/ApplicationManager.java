...
import com.zju.section.dto.QueryApplicationResponse;
import com.zju.section.dto.TeacherApplicationHistoryResponse;
import com.zju.section.dto.ApplicationHistoryDetailResponse;
...
public class ApplicationManager {
     ...
     */    public ApiResult<?> queryAllApplicationsByTeacher(Integer teacherId) {
        ...
        try {
            List<java.util.Map<String, Object>> all = applicationRepository.findHistoryWithDetailByTeacherId(teacherId);
            java.util.List<com.zju.section.dto.ApplicationHistoryDetailResponse> result = new java.util.ArrayList<>();
            for (java.util.Map<String, Object> row : all) {
                com.zju.section.dto.ApplicationHistoryDetailResponse dto = new com.zju.section.dto.ApplicationHistoryDetailResponse();
                dto.setSecId((Integer) row.get("sec_id"));
                dto.setReason((String) row.get("reason"));
                dto.setTeacherId((Integer) row.get("teacher_id"));
                dto.setSuggestion((String) row.get("suggestion"));
