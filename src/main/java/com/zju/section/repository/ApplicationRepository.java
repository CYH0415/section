...
public interface ApplicationRepository extends JpaRepository<Application, Integer> {
    ...
    @org.springframework.data.jpa.repository.Query(value = """
        ...
        """, nativeQuery = true)
    List<java.util.Map<String, Object>> findHistoryWithDetailByTeacherIdPaged(@org.springframework.data.repository.query.Param("teacherId") Integer teacherId, @org.springframework.data.repository.query.Param("limit") int limit, @org.springframework.data.repository.query.Param("offset") int offset);
}